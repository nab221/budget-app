...
- [x] **v1.2: Daily Cash Flow Engine** — [ROADMAP](milestones/v1.2-ROADMAP.md) | [REQUIREMENTS](milestones/v1.2-REQUIREMENTS.md)
- [x] **v1.1: UX Refinement & CRUD Hardening** — assumed complete
- [x] **v1.0: Modular Rebuild & Foundation** — [ROADMAP](milestones/v1.0-ROADMAP.md) | [REQUIREMENTS](milestones/v1.0-REQUIREMENTS.md)
