...
| 7. Code Inconsistencies & Inefficiencies | 3/3 | Completed | 2026-03-07 |
...
Plans:
- [x] 07-01-PLAN.md — Wave 1: Test scaffolding (advanceNextDate tests + balance equality integration test)
- [x] 07-02-PLAN.md — Wave 2: Bug fixes (advanceNextDate, markAllAsPaid/recordPayment, balance engine unification)
- [x] 07-03-PLAN.md — Wave 3: Dead code removal (barForecastPlugin, BarController/BarElement, aggregateRollingOverview, getRollingFinancialData, binning param)
