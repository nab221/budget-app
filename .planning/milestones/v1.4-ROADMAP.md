# Milestone Roadmap: Local File Persistence (v1.4 - Porting)

Milestone Goal: Port the File System Access API integration from `budget-app.html` to the modern modular architecture.
...
|-------|----------------|--------|-----------|
| 1. Repository Refactor | 0/1 | Not started | - |
